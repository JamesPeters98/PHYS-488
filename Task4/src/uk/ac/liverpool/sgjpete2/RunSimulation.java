...
//		    		       txyz[2] + ", " + txyz[3] + "]");
	    ...
	    double [] det_pos = Particles_det[0].getPosition(2);
 	    ...
 	    double det1Theta = Math.acos((smear(0.01)*det_pos[3]-pos0[3])/
					 Math.sqrt(Math.pow(smear(0.01)*smear(0.01)*det_pos[1]-pos0[1], 2)
						   +Math.pow(smear(0.01)*smear(0.01)*det_pos[2]-pos0[2], 2)
						   +Math.pow(smear(0.01)*smear(0.01)*det_pos[3]-pos0[3], 2)));
	    ...
	    det_pos = Particles_det[0].getPosition(3);
 	    double det2Theta = Math.acos((smear(0.01)*det_pos[3]-pos0[3])/
					 Math.sqrt(Math.pow(smear(0.01)*det_pos[1]-pos0[1], 2)
						   +Math.pow(smear(0.01)*det_pos[2]-pos0[2], 2)
						   +Math.pow(smear(0.01)*det_pos[3]-pos0[3], 2)));
