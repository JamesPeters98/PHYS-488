...
class Geometry
{
    ...
    {
		// CHECK AND COMPLETE HERE - similar to doEloss function
    	...
    	if (volume >= 0) {
    		double theta0 = MultScatter[volume].getTheta0(p);
	
    		if(theta0 > 0) {
				double gausx = randGen.nextGaussian()*theta0;
				double gausy = randGen.nextGaussian()*theta0;
